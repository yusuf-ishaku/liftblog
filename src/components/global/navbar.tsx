  ...
  return (
    <>
      <nav className="sticky top-4 /top-[41px] z-10">
        <div className="h-[97px] mt-[41px] mx-[80px] rounded-[10px] px-[32px] pt-[26px] pb-[27px] flex items-center justify-between border border-solid [border-image-source:linear-gradixent(90.38deg,#00111E_18.59%,rgba(141,141,141,0)_105.12%)] bg-background">
